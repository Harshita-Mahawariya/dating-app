...
ActiveRecord::Schema.define(version: 2023_02_22_112440) do
  ...
  create_table "bx_block_knowyourcustomerkycverification2_onfidos", force: :cascade do |t|
    t.string "document_type"
    t.string "onfido_applicant_id"
    t.string "onfido_check_id"
    t.string "onfido_report_id"
    t.integer "kyc_status", default: 0
    t.string "reports_status"
    t.string "email"
  end
